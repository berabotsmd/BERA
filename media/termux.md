...
1. **Cloning the Repository**:
   - `git clone https://github.com/berabotsmd/BERA`: Clones the repository into the current directory.
   - `cd BERA`: Changes the directory to the cloned repository folder.
